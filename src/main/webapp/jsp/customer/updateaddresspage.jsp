              ...
              <div class="u-container-layout u-valign-bottom-lg u-valign-bottom-md u-valign-bottom-sm u-valign-bottom-xs u-container-layout-1">
                ...
                <div class="u-expanded-width u-form u-form-1">
                  ...
                  <form action="updateAddress" >
                      Name<br><input type="text" name="name" value="<%=address.getName()%>" style="color:black" required ><br>
                      <br>
                    
                      House No <br> <input type="text" name="houseNo" value="<%=address.getHouseNo()%>" style="color:black" required><br>
                      <br>
                   
                      Street <br>    <input type="text" name="street" value="<%=address.getStreet()%>" style="color:black" required><br>
                      <br>
                    
                      City <br>    <input type="text" name="city" value="<%=address.getCity()%>" style="color:black" required><br>
                      <br>
                      State <br>    <input type="text" name="state" value="<%=address.getState()%>" style="color:black" required> <br>
                      <br>
                      Country <br>   <input type="text" name="country" value="<%=address.getCountry()%>" style="color:black"  required><br>
                      <br>
                      Postal code <br>    <input type="text" name="postalCode" value="<%=address.getPostalCode()%>" style="color:black" required><br>
                      <br>
                      
                      <input type="submit" value="Update" style="background-color: black; color:white"><br>
