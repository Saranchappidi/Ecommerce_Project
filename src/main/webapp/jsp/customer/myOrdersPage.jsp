...
<link rel="stylesheet" href="css/customer/MyOrders.css" media="screen">
    ...
    <meta property="og:title" content="MyOrders">
  ...
  <body class="u-body u-xl-mode" data-lang="en"><header class="u-align-right u-box-shadow u-header u-valign-bottom u-white u-header" id="sec-c7d9" data-animation-name="" data-animation-duration="0" data-animation-delay="0" data-animation-direction=""><form action="customerBrowse" method="get" class="u-border-1 u-border-grey-50 u-search u-search-right u-search-1">
    ...
    <section class="u-align-center u-clearfix u-custom-color-13 u-section-1" id="sec-41a7">
      <c:forEach items="${orderlist}" var="list">
        <c:forEach items="${list.cartlines}" var="cartline">
      <div class="u-clearfix u-sheet u-sheet-1">
        <div class="u-clearfix u-expanded-width u-gutter-0 u-layout-wrap u-layout-wrap-1">
          <div class="u-layout" style="">
            <div class="u-layout-row" style="">

              <div class="u-align-left u-container-style u-image u-layout-cell u-left-cell u-size-13 u-size-xs-60 u-image-1" style="background-image: url('${cartline.product.prodImage}');" data-image-width="1080" data-image-height="1080">
                <div class="u-container-layout u-valign-middle u-container-layout-1" src=""></div>
              </div>
              <div class="u-align-left u-container-style u-layout-cell u-right-cell u-size-47 u-size-xs-60 u-white u-layout-cell-2">
                <div class="u-container-layout u-container-layout-2">
                  <h2 class="u-text u-text-custom-color-16 u-text-default u-text-1">${cartline.product.prodName}</h2>
                  <p class="u-text u-text-2">${cartline.product.prodPrice}</p>
                  <p class="u-text u-text-2">${cartline.productCount}</p>
                  <p class="u-text u-text-2">${cartline.total}</p>
                  <a href="singleProductCustomer?prodId=${cartline.product.prodId}" class="u-border-2 u-border-white u-btn u-btn-rectangle u-button-style u-custom-color-18 u-text-hover-white u-btn-1">Single Product Page</a>
                  <h4 class="u-text u-text-custom-color-16 u-text-3">&nbsp;&nbsp;</h4>
                  <h6 class="u-text u-text-custom-color-16 u-text-4">&nbsp;Status</h6>
                  <p class="u-text u-text-5">${list.status}</p>
                </div>
              </div>
            </div>
          </div>
