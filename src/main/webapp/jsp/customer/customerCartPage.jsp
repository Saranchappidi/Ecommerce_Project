      ...
      <div class="u-clearfix u-expanded-width u-gutter-0 u-layout-wrap u-layout-wrap-1">
        ...
        <div class="u-layout" style="">
          ...
          <div class="u-layout-row" style="">
            <div class="u-align-left u-container-style u-image u-layout-cell u-left-cell u-size-13 u-size-xs-60 u-image-1" style="background-image:url('${list.product.prodImage}');" data-image-width="1080" data-image-height="1080">
            ...
            <div class="u-align-left u-container-style u-custom-color-16 u-layout-cell u-right-cell u-size-47 u-size-xs-60 u-layout-cell-2">
              <div class="u-container-layout u-container-layout-2">
                <h2 class="u-text u-text-custom-color-20 u-text-default u-text-1">${list.product.prodName}</h2>
                <p class="u-text u-text-2"></p><span class="u-file-icon u-icon u-white u-icon-1"><a href="addQuantCartLine?cartLineId=${list.id}"><img src="img/875068-0d6a9ac7.png" alt=""></a></span>
                <a href="removeFromCart?cartLineId=${list.id}" class="u-active-custom-color-12 u-border-2 u-border-white u-btn u-button-style u-hover-black u-text-body-color u-text-hover-white u-white u-btn-1">Remove From Cart</a>
                <a href="singleProductCustomerCart?prodId=${list.product.prodId}" class="u-border-2 u-border-white u-btn u-btn-rectangle u-button-style u-hover-black u-text-hover-white u-white u-btn-2">Single Product Page</a><span class="u-file-icon u-icon u-white u-icon-2"><a href="minusQuantCartLine?cartLineId=${list.id}"><img src="img/4153143-10a9c3cd.png" alt=""></a></span>
                <center>
                  <div style="margin-top:90px;">
                  Quantity ${list.productCount}
                  Price ${list.product.prodPrice}
                  Total Price ${list.total}
                </div>
                </center>
                <br>
            ...
            <div class="u-layout-row">
              <div class="u-align-center-sm u-align-center-xs u-align-left-lg u-align-left-md u-align-left-xl u-container-style u-layout-cell u-left-cell u-size-43 u-layout-cell-1">
                <div class="u-container-layout u-container-layout-1">
                  ...
                  <a href="buyCartLines" style="position:absolute; right:0; background-color: white; color: black; padding:20px; ">Order</a>
