...
<c:forEach var="list" varStatus="status" items="${productlist}" step="1" begin="0">
          <div class="u-container-style u-custom-color-16 u-list-item u-repeater-item">
            <div class="u-container-layout u-similar-container u-container-layout-${status.index % 3 + 1}">
              ...
              <a href="singleProductCustomer?prodId=${list.prodId}" class="u-active-none u-border-hover-palette-2-base u-border-none u-border-palette-2-light-1 u-btn u-button-style u-hover-custom-color-20 u-text-body-color u-white u-btn-1">View Product</a>
            </div>
          </div>
        </c:forEach>
          <!-- <div class="u-container-style u-custom-color-16 u-list-item u-repeater-item">
