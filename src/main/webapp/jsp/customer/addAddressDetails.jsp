          ...
          <div class="u-layout-row">
            <div class="u-container-style u-custom-color-5 u-layout-cell u-right-cell u-size-60 u-layout-cell-1">
              <div class="u-container-layout u-valign-bottom-lg u-valign-bottom-md u-valign-bottom-sm u-valign-bottom-xs u-container-layout-1">
                <h2 class="u-text u-text-black u-text-default u-text-1">Add Address</h2>
                <%Customer customer=(Customer)session.getAttribute("customersession");%><br>
            <br>
                <div class="u-expanded-width u-form u-form-1">
                    <center>
                      <form:form action="addAddress" modelAttribute="addressvalid" >
                        Name<br><form:input type="text" name="name" path="name" style="color:black" required="true"/><br>
                        <br>
                      
                        House No <br> <form:input type="text" name="houseNo" path="houseNo" style="color:black" required="true"/><br>
                        <form:errors path="houseNo" cssClass="error"/><br>
                     
                        Street <br>    <form:input type="text" name="street" path="street" style="color:black" required="true"/><br>
                        <br>
                        City <br>    <form:input type="text" name="city" path="city" style="color:black" required="true"/><br>
                      <br>
                      State <br>    <form:input type="text" name="state" path="state"  style="color:black" required="true"/> <br>
                      <br>
                      Country <br>   <form:input type="text" name="country" path="country" style="color:black"  required="true"/><br>
                      <br>
                      Postal code <br>    <form:input type="text" name="postalCode" path="postalCode" style="color:black" required="true"/><br>
                      <form:errors path="postalCode" cssClass="error"/><br><br>
                      <br>
                      
                      <input type="submit" value="Add" style="background-color: black; color:white"><br>
