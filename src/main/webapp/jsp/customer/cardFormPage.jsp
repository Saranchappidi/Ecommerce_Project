...
<button class="u-search-button" type="submit">
  ...
  <section class="u-align-center u-clearfix u-custom-color-14 u-section-1" id="carousel_f3a3">
    <div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
      <center>
      <h2 class="u-custom-font u-text u-text-body-color u-text-default u-text-1">Enter Card details</h2>
    </center>
      <div class="u-form u-form-1">
          <center>
          
            <form:form action="checkCardValidity" modelAttribute="checkValid">
          	
              Card Number:&nbsp;&nbsp;&nbsp;<form:input type="text" name="cardNumber" placeholder="123456789012" path="cardNumber" required="true"/>
              <form:errors path="cardNumber" cssClass="error"/><br><br>
              
              Account Name:&nbsp;&nbsp;&nbsp;<form:input type="text" name="cardHolderName" path="cardHolderName" placeholder="Marc Jones" required="true"/><br><br>
              
              Expiry Month:&nbsp;&nbsp;&nbsp;<form:input type="month" name="expiryMonth" path="expiryMonth" required="true"/><br><br>
              
              CVV:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<form:input type="text" name="cardCVV" path="cardCVV" placeholder="123" required="true"/><br><br>
              <form:errors path="cardCVV" cssClass="error"/><br><br>
