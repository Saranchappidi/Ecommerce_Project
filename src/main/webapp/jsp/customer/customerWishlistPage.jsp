...
<link rel="stylesheet" href="css/customer/productList.css" media="screen">
  ...
  <body class="u-body u-xl-mode" data-lang="en"><header class="u-align-right u-box-shadow u-header u-valign-bottom u-white u-header" id="sec-c7d9" data-animation-name="" data-animation-duration="0" data-animation-delay="0" data-animation-direction=""><form action="customerBrowse" method="get" class="u-border-1 u-border-grey-50 u-search u-search-right u-search-1">
    ...
    <section class="u-clearfix u-valign-bottom u-white u-section-1" id="sec-f131">
      <div class="u-expanded-width u-list u-list-1">
        <div class="u-repeater u-repeater-1">
         

<c:forEach var="list" varStatus="status" items="${productlist}" step="1" begin="0">
          <div class="u-container-style u-custom-color-16 u-list-item u-repeater-item">
            <div class="u-container-layout u-similar-container u-container-layout-${status.index % 3 + 1}">
              <img alt="" class="u-expanded-width u-image u-image-default u-image-1" data-image-width="1333" data-image-height="2000" src="<c:out value="${list.prodImage}" /> ">
              <h3 class="u-text u-text-default u-text-1"><c:out value="${list.prodName}" />  </h3>
              <p class="u-text u-text-2"></p>
              <a href="singleProductCustomerWishlist?prodId=${list.prodId}" class="u-active-none u-border-hover-palette-2-base u-border-none u-border-palette-2-light-1 u-btn u-button-style u-hover-custom-color-20 u-text-body-color u-white u-btn-1">View Product</a>
            </div>
          </div>
        </c:forEach>
          <!-- <div class="u-container-style u-custom-color-16 u-list-item u-repeater-item">
            <div class="u-container-layout u-similar-container u-container-layout-2">
              ...
              <a href="Single-Product-Page.html" class="u-active-none u-border-hover-palette-2-base u-border-none u-border-palette-2-light-1 u-btn u-button-style u-hover-custom-color-20 u-text-body-color u-white u-btn-2">Single Product Page</a>
            </div>
          </div>
          <div class="u-container-style u-custom-color-16 u-list-item u-repeater-item">
            <div class="u-container-layout u-similar-container u-container-layout-3">
              ...
              <a href="Single-Product-Page.html" class="u-active-none u-border-hover-palette-2-base u-border-none u-border-palette-2-light-1 u-btn u-button-style u-hover-custom-color-20 u-text-body-color u-white u-btn-3">Single Product Page</a>
            </div>
          </div> -->
        </div>
      </div>
