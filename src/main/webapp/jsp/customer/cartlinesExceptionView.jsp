...
<button class="u-search-button" type="submit">
    ...
    <center>
 <h3 style="margin-top: 150px;">${exceptionMessage}</h3><br><br><br>
 <a href="backToCustomerHomepage" style="background-color:white;color:black;padding: 20px;">Back To home</a>
