                  ...
                  <div class="u-align-left u-container-style u-layout-cell u-right-cell u-size-30 u-white u-layout-cell-1">
                    <div class="u-container-layout u-container-layout-1">
                      ...
                      <ul class="u-text u-text-2">
                        ...
                        <li>
                          <span class="u-text-black" style="font-weight: 700;">Rating:<span style="font-weight: 400;"><%=product.getProdRating()%></span>
                          </span>
                        </li>
                      </ul>
                      ...
                      <%} else{%>
                        <a href="addToWishlist"  class="u-border-2 u-border-grey-75 u-btn u-button-style u-custom-color-20 u-hover-black u-btn-1" id="btn1" o >Add to wishlist</a>
                      <% } %>
