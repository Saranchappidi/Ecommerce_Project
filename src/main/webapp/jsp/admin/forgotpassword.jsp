            ...
            <center>
              <form action="forgotPassword">  
                <input type="text" name="adminId" value="${adminId}" hidden>                
                      New Password:<input type="password" name="adminPassword" placeholder="Enter New Password" required /><br><br>
                     Confirm Password:<input type="password"  name="adminconfirmPassword" placeholder="Enter ConfirmPassword" required/><br><br>       
