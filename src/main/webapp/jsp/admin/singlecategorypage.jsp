...
<html style="font-size: 16px;" lang="en"><head>
    ...
    <title>singlecategorypage</title>
    <link rel="stylesheet" href="css/nicepage1.css" media="screen">
<link rel="stylesheet" href="css/singlecategorypage.css" media="screen">
    ...
    <meta property="og:title" content="singlecategorypage">
...
<section class="u-clearfix u-custom-color-8 u-section-1" id="sec-52ff">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h3 class="u-text u-text-default u-text-1"><%=category.getCategoryName()%></h3>
        <a href="addProduct" class="u-btn u-button-style u-hover-palette-1-dark-1 u-palette-1-base u-btn-1">add product</a>
        <a href="deleteCategory" class="u-btn u-button-style u-hover-palette-1-dark-1 u-palette-1-base u-btn-2">Delete category</a>
        <a href="backToCategorypage" class="u-btn u-button-style u-hover-palette-1-dark-1 u-palette-1-base u-btn-3">Back To Category</a>
            ...
            <div class="u-layout-col">
              <div class="u-size-60">
                <div class="u-layout-row">
                  <div class="u-container-style u-image u-layout-cell u-left-cell u-size-30 u-image-1" style="background-image:url('${list.prodImage}');" src="" data-image-width="5616" data-image-height="3744">
                    <div class="u-container-layout u-valign-middle u-container-layout-1">
                    </div>
                  </div>
                  
                  <div class="u-align-left u-container-style u-layout-cell u-palette-1-light-1 u-right-cell u-size-30 u-layout-cell-2">
                    <div class="u-container-layout u-container-layout-2">
                      <h2 class="u-text u-text-2"><c:out value="${list.prodName}"/></h2>
                      <p class="u-text u-text-3">${list.description}</p>
                      <a href="singleProduct?prodId=${list.prodId}" class="u-border-2 u-border-white u-btn u-btn-rectangle u-button-style u-palette-1-base u-btn-4">Edit Product</a>
                    </div>
                  </div>
                </div>
              </div>
